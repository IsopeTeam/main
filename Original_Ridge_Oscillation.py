# -*- coding: utf-8 -*-
"""
Created on Fri Apr  5 11:24:24 2019
...
#-----------------------------------------------------------------------------------------------------------------
    ...
    file_loc ='D:/F.LARENO.FACCINI\Preliminary Results/Ephy/2535 (Baseline of 3s - Atlas)/HDF5/1300/P2/rbf/Concatenate/conc/2019-03-06T17-54-30Concatenate_1300um_P2.rbf'
...
#-----------------------------------------------------------------------------------------------------------------  
    ...
    complex_map, map_times, freqs, tfr_sampling_rate = compute_timefreq(sig[:,ch], sampling_rate, f_start, f_stop, delta_freq=0.1, nb_freq=None,
