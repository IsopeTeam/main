...
@author: ludovic.spaeth (modified by Federica Lareno Faccini)
...
def convert_folder(folderpath, newpath, length, data_type='filt', transpose=True):
...
#            print(sigs.shape)
            ...
            with open(file_save, mode='wb') as file : 
                ...
                if transpose == True:                
                    sigs.transpose().tofile(file,sep='')
                    
                else:
                    sigs.tofile(file,sep='')                    
...
if __name__ == '__main__':
    ...
    folderpath = 'D:/F.LARENO.FACCINI/Preliminary Results/Ephy/Coordinate Hunting/858/HDF5/'
    newpath = 'D:/F.LARENO.FACCINI/Preliminary Results/Ephy/Coordinate Hunting/858/RBF/'
    length = 15
    
    
    convert_folder(folderpath, newpath, length)