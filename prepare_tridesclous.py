# -*- coding: utf-8 -*-
"""
Created on Tue Dec  3 18:24:24 2019
...
basedir = 'D:/F.LARENO.FACCINI/Preliminary Results/Ephy/Coordinate Hunting/855/RBF/VII/P13/Concatenate/'
datadir = basedir# + 'Concatenate/'
...
def explore():
    ...
    for ind, row in files.iterrows():
        ...
        pattern = '(\d+)\-(\d+)\-(\d+)T(\d+)-(\d+)-(\d+)Concatenate'
...
def create_tridesclous_workdir():
    ...
    for group_name in group_names:
        ...
        # set the probe file
        dataio.set_probe_file('D:/F.LARENO.FACCINI/Preliminary Results/Ephy/good_atlas_probe_for_real.prb')
        ...
        for chan_grp in dataio.channel_groups.keys():
            ...
            fullchain_kargs = {
                ...
                'preprocessor' : {
                    ...
                    'smooth_size' : 0,
                    'chunksize' : 1024,
                    'lostfront_chunksize' : 0,    # default by Sam 128
                    'signalpreprocessor_engine' : 'numpy',
                },
                'peak_detector' : {
                    'peakdetector_engine' : 'numpy',
                    'peak_sign' : '-',
                    'relative_threshold' : 9,
                    'peak_span' : 0.0002,
                },
                'noise_snippet' : {
                    'nb_snippet' : 300,
            ...
            feat_kargs = {'n_components': 7}  # just tryin'. default: empty
