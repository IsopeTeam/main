...
@author: Ludo (modified from Sam Garcia)
...
path =r'D:\F.LARENO.FACCINI\Preliminary Results\Ephy\Coordinate Hunting\855\RBF\VII\P19\Concatenate\tdc_workdirs\2019-10-10_1300.0'
...
name = '855-1300-P19-VII'

#Where to save datasheets and figures. If None, nothing will be saved  - must be STRING format
savedir = r'D:/F.LARENO.FACCINI/Preliminary Results/Ephy/Coordinate Hunting/855\RBF/VII/P19/Concatenate/tdc_workdirs/'
